...
function HomePage() {
    return (
        <div className="flex flex-col gap-8 px-4 py-4 lg:flex-row lg:justify-between">
            <div className="flex max-w-lg flex-col justify-between rounded-md bg-sky-100 px-6 py-3 sm:min-w-96 sm:px-12 sm:py-6">
                <div>
            ...
            <div className="flex max-w-lg flex-col justify-between rounded-md bg-rose-100 px-6 py-3 sm:min-w-96 sm:px-12 sm:py-6">
                <div>
